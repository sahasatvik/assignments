...
\begin{document}
    ...
    \begin{proof}
        ...
        Furthermore, set $x = k / n$, $0 < k < n$ with $k$ and $n$ co-prime. We claim
        ...
        k' < n'$, $k'$ and $n'$ are co-prime. The minimality of $x$ gives $x < y$,
    ...
    \end{proof}
    \begin{remark}
        If $m$ and $n$ are coprime, they share no common factors greater than $1$.
        Note that $m\Z + n\Z$ is a subgroup of the integers, and hence there is
        exists a unique positive integer $d$ such that $m\Z + n\Z = d\Z$. Since $m, n
        \in m\Z + n\Z$, we have $m, n \in d\Z$ so there exist $r_1$, $r_2$ such that
        $m = dr_1$, $n = dr_2$. This means that $d$ is a common factor of $m$ and
        $n$, forcing $d = 1$, i.e.\ $m\Z + n\Z = \Z$. Since $1 \in \Z$, $1 \in
        m\Z + n\Z$, hence there exists a combination $mp + nq = 1$.
    \end{remark}
