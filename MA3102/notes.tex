...
\begin{document}
    ...
    \begin{definition}
        Let $N$ be a subgroup of the group $G$. We say that $N$ is a normal subgroup
        of for every $n \in N$, we have $g^{-1} ng \in N$ for all $g \in G$.
    \end{definition}
    \begin{lemma}
        A subgroup $N$ is normal if and only if $gN = Ng$ for all $g \in G$. In other
