...
\begin{document}
    ...
    \begin{proof}
        ...
        \] When $|R| = s$, compute $P(A_R)$ is twice the above probability. We will
        show that the probability of the existence of a monochromatic $s$-clique is
        strictly less than $1$. To see this, apply the Inclusion-Exclusion principle,
