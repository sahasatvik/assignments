...
\begin{document}
    ...
    \begin{theorem}[Hirsch-Smale Theory]
        ...
        \begin{enumerate}
            \itemsep0em
            \item Any two immersed loops in $\R^2$ are isotopic if and only if the
            winding numbers match.
            \item Any two immersed loops in $S^2$ are isotopic if and only if the
            winding numbers modulo 2 match.
        \end{enumerate}
    \end{theorem}
