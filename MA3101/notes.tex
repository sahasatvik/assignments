...
\begin{document}
    ...
    \end{definition}
    \begin{example}
        The boundary of the unit open ball $B_0(0) \subset \R^n$ is the sphere $S^{n
        - 1}$.
    \end{example}
    ...
    \begin{definition}
        A topology on a set $X$ is a collection of sets $\tau$ such that
        \begin{enumerate}
            \itemsep0em
            \item $\emptyset \in \tau$
            \item $X \in \tau$
    ...
    \begin{definition}
        ...
        $K$ has a finite sub-cover. That is, for every collection if $\{U\}_{\alpha \in A}$
        of open sets such that $K$ is contained in their union, then there exists a
        finite sub-collection $U_{\alpha_1}, \dots, U_{\alpha_k}$ such that $K$ is
        also contained in their union.
    \end{definition}
    \begin{example}
