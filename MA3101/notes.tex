...
\begin{document}
    ...
    \begin{proof}
        ...
        $\gamma^{-1}(U)$, $\gamma^{-1}(V)$ constitutes a separation of $X$, which is
        a contradiction.
    \end{proof}
    ...
    \begin{theorem}
        Let $f\colon \R^n \to \R$ have continuous second order partial derivatives.
        Then, \[
    ...
    \begin{theorem}
        ...
        \begin{align*}
            ...
            y),
        \end{align*}
        where as $(x, y) \to (x_0, y_0)$, the remainder term vanishes as \[
    ...
    \begin{example}
        ...
        in $\R^2$. We may denote \[
            \int_\gamma f \cdot ds = \int_\gamma f^1\:dx + f^2\:dy.
        \] 
    \end{example}
