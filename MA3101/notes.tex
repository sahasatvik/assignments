...
\begin{document}
    ...
    \begin{definition}
        ...
        \] The derivative of $f$ at $x$ is denoted by $\lambda = D_xf$.
        \begin{remark}
            In a neighbourhood of $x$, we may approximate \[
                f(x + h) \approx f(x) + D_xf(h).
            \] 
        \end{remark}
        \begin{remark}
            The statement that this norm goes to zero means that each of the $m$
    ...
    \begin{example}
        ...
        see that $T$ is differentiable everywhere.
    \end{example}
    ...
    \begin{lemma}
        ...
        \begin{enumerate}
            ...
            \item The linear transformation $D_xf$ is unique.
        \end{enumerate}
    \end{lemma}
