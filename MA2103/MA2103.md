...
$$ u(x, t) = \sum_{n = 1}^\infty A_n \sin\frac{n\pi x}{\ell}\,\exp\left(-k^2\alpha^2 t\right). $$
...
$$ u(x, t) = u_f(x) \,+\, \sum_{n = 1}^\infty B_n \sin\frac{n\pi x}{\ell}\,\exp\left(-k^2\alpha^2 t\right). $$
